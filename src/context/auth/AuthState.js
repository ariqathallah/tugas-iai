...
const AuthState = props => {
  ...
  const register = async userData => {
    try {
      ...
      swal('', 'Akun telah berhasil ditambahkan! Anda akan dialihkan ke dashboard admin beberapa saat lagi . . .', 'success', {
        timer: 2000
      });
      ...
      swal('', 'Terjadi kegagalan saat mendaftarkan akun. Silakan untuk mengulangi proses pendaftaran lagi', 'error');
